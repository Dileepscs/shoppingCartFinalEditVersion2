...
<script>
    $(document).ready(function () {
        ...
        function createProductCard(product) {
            ...
            let id = product.id;
            btn.click(function (id) { // Correct spelling and syntax
                var url = "/AddToCartController?pid="+id; // The endpoint URL

                fetch(url, {
                    method: "GET", // Use POST method for creating/updating data
                    headers: {
